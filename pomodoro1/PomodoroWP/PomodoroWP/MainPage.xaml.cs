...
namespace PomodoroWP
{
    public partial class MainPage : PhoneApplicationPage
    {
        ...
        private static bool fetchingValue = false;
        ...
        {
            _currentTask = TaskListBox.SelectedItem.ToString();
            CurrentTask.Text = _currentTask;
        }
       ...
       void NewTaskButton_Click( object sender, RoutedEventArgs e )
        ...
        private void RestoreState()
        {
            ...
            if (_isoSettings.TryGetValue( "CurrentTask", out outVal ))
            {
                _currentTask = outVal as string;
                CurrentTask.Text = _currentTask;
            }
        ...
        private void SaveState()
        {
            ...
            if (_isoSettings.Contains( "CurrentTask" ))
                _isoSettings["CurrentTask"] = _currentTask;
            else
                _isoSettings.Add( "CurrentTask", _currentTask );
        ...
        protected override void OnNavigatedTo( System.Windows.Navigation.NavigationEventArgs e )
        {
            ...
            if (NavigationContext.QueryString.TryGetValue( "NewTask", out newMessage ) && fetchingValue )
            {
